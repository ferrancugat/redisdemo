...
public interface RedisOperation {
     ...
     * Clustered Setup (sharding), Clustered Setup Master-Slave. https://dzone
     * .com/articles/multi-tenancy-in-redis-enterprise. The decision taken is that RedisOperation should be
     * agnostic of the logical instance where the data is fetched. Thats the reason why the DB reference is passed as
     * argument.
     *
